        ...
        return (
            <nav className="navbar navbar-expand-lg navbar-light bg-light py-3 sticky-top">
                <div className="container">
                    <NavLink className="navbar-brand fw-bold fs-4 px-2" to="/"> NetMeds Pharmacy For You</NavLink>
                    ...
                    <div className="collapse navbar-collapse d-flex align-items-center justify-content-center" id="navbarSupportedContent">
                        <ul className="navbar-nav m-auto d-flex justify-content-center my-2 text-center">
                            ...
                            <li className="nav-item d-flex align-items-center">
                                <button className="btn btn-outline-dark m-2" onClick={logout}><i className="fa fa-sign-in-alt mr-1"></i>Logout</button>
